...
export const acceptFriendRequest = async (req, res) => {
    try {
        ...
        console.error('Error during accept friend request:', error);
        return res.status(500).json({ message: 'Internal server error' });
    }
};
...
export const declineFriendRequest = async (req, res) => {
    try {
        ...
        console.error('Error during decline friend request:', error);
        return res.status(500).json({ message: 'Internal server error' });
    }
};
...
export const getAllFriends = async (req, res) => {
    try {
        ...
        console.error('Error during get all friends:', error);
        return res.status(500).json({ message: 'Internal server error' });
    }
};
...
export const getFriendRequests = async (req, res) => {
    try {
        ...
        console.error('Error during get friends request:', error);
        return res.status(500).json({ message: 'Internal server error' });
    }
};
